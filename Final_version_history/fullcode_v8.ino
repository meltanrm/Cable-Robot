...
/*  float testDiff[3];
  testDiff[0]=D_1[0]-D_1atplat[0];
  testDiff[1]=D_1[1]-D_1atplat[1];
  testDiff[2]=D_1[2]-D_1atplat[2];
 
  Serial.println("testing diff:");
  Serial.println(testDiff[1]); */
  ...
  Serial.println("length of cable at position 0");
  Serial.println(l_d1_0);
  Serial.println("length of cable at position 1");
  Serial.println(l_d1);
  Serial.println("LineDiff for D:");
